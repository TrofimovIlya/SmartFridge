package ru.hse.smartrefrigerator.services;
...
public class SRNotifyService extends Service {
    private static final String ESTIMOTE_PROXIMITY_UUID = PrivateData.getBeacon();
                            ...
                            public void onFound(List<String> products) {
                                ...
                                if (!year.equals(lastCheckBeaconYear) || !month.equals(lastCheckBeaconMonth) || !day.equals(lastCheckBeaconDay)) {
                                    ...
                                    Notification n = new Notification.Builder(context)
                                            ...
                                            .setStyle(new Notification.BigTextStyle().bigText(String.format(getString(R.string.advice_content), require)))
                                            .build();
                ...
                if (!year.equals(lastExpNotifyYear) || !month.equals(lastExpNotifyMonth) || !day.equals(lastExpNotifyDay)) {
                    ...
                    if (!expire.isEmpty()) {
                        ...
                        Notification n = new Notification.Builder(context)
                                ...
                                .setSmallIcon(R.drawable.notificon)
                                .setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION))
                                .setContentIntent(pendingIntent).setStyle(new Notification.BigTextStyle().bigText(String.format(getString(R.string.expires_content), require))).build();
